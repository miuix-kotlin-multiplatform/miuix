...
fun lightColorScheme(
    ...
    disabledPrimaryButton: Color = Color(0xFFEBF1FD),
    disabledOnPrimaryButton: Color = Color(0xFFFAFAFF),
    disabledPrimarySlider: Color = Color(0xFFB4D1FF),
    ...
    disabledSecondaryVariant: Color = Color(0xFFF5F5F5),
    ...
    onSecondaryContainerVariant: Color = Color(0xFFA9A9A9),
    tertiaryContainer: Color = Color(0xFFEBF3FF),
    onTertiaryContainer: Color = Color(0xFF3482FF),
    tertiaryContainerVariant: Color = Color(0xFFEBF3FF),
    ...
    surfaceContainerHigh: Color = Color(0xFFEDEDED),
    onSurfaceContainerHigh: Color = Color(0xFFA5A5A5),
...
fun darkColorScheme(
    ...
    disabledPrimaryButton: Color = Color(0xFF1E2B43),
    disabledOnPrimaryButton: Color = Color(0xFF505A6E),
    disabledPrimarySlider: Color = Color(0xFF435C81),
    primaryContainer: Color = Color(0xFF338FE4),
    onPrimaryContainer: Color = Color.White,
    secondary: Color = Color(0xFF4F4F4F),
    onSecondary: Color = Color.White,
    secondaryVariant: Color = Color(0xFF3A3A3A),
    onSecondaryVariant: Color = Color(0xFFAAAAAA),
    disabledSecondary: Color = Color(0xFF3F3F3F),
    disabledOnSecondary: Color = Color(0xFF707070),
    disabledSecondaryVariant: Color = Color(0xFF434343),
    disabledOnSecondaryVariant: Color = Color(0xFF646464),
    secondaryContainer: Color = Color(0xFF2C2C2C),
    onSecondaryContainer: Color = Color(0xFF5D5D5D),
    ...
    tertiaryContainerVariant: Color = Color(0xFF4F4F4F),
    ...
    surfaceContainerHigh: Color = Color(0xFF2D2D2D),
    onSurfaceContainerHigh: Color = Color(0xFF6C6C6C),
