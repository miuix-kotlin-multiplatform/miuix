...
val MiuixIcons.Search: ImageVector
    get() {
        ...
        _search = ImageVector.Builder("Search", 20.dp, 20.dp, 20.0f, 20.0f).apply {
            path(
                ...
                curveTo(4.254f, 6.051f, 6.305f, 4.0f, 8.835f, 4.0f)
                curveTo(11.365f, 4.0f, 13.416f, 6.051f, 13.416f, 8.581f)
                close()
            }
        }.build()
        return _search!!
